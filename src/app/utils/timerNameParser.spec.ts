...
describe("timerNameParser", () => {
  it.each([
    ...
    [
      "https://mobtime.vehikl.com/test",
      { name: "test", server: "https://mobtime.vehikl.com" },
    ],
    [
      "https://mobtime.vehikl.com/////134324",
      { name: "134324", server: "https://mobtime.vehikl.com" },
    ],
    [
      "https://mobti.me/test-test",
      { name: "test-test", server: "https://mobti.me" },
    ],
    [
      "https://www.npmjs.com/package",
      { name: "package", server: "https://www.npmjs.com" },
    ],
